...
MetalLB IPs: total=51 used=35 free=16
...
| minecraft-fox | default | 10.0.0.213 |
...
| kube-prometheus-stack-prometheus | monitoring | 10.0.0.230 |
| kube-prometheus-stack-alertmanager | monitoring | 10.0.0.231 |
| kube-prometheus-stack-grafana | monitoring | 10.0.0.232 |
